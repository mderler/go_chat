...
func (h *IndexHandler) ShowIndex(c echo.Context) error {
	messages := []index.Message{
		{Author: "Stefan Derler", Color: "#ff0000", Message: "Hello World!", Left: true},
		{Author: "Matthias Derler", Color: "#ff00ff", Message: "Hello World!", Left: false},
	}
	...
	return render(c, index.Show(user, messages))
}
